...
KOREAN_STOP_WORDS = {"청년","지역","광주","전남","정보","경우","부분","요즘","실제로","개인적으로","생각합니다","좋겠습니다","어렵다","어렵습니다","필요하다","필요합니다","있으면","입장","입장에서","사람","생각","의견","문제","때문","관련","대한","대해","통해","위해","있는","없는","같은","다른","많은","좋은","해당","우리","저희","그냥","정도","때문에","점이","가장","번에","찾기","추천","추천받고","합니","의견입니","입니","겁니","겁니다","합니다","입니다","있다","없다","같다","보다","통해","위해","대해","관해","경우","때문","정도","사람","생각","의견","문제","부분","정보","지역","청년","광주","전남","해당","그냥","정도","때문에","가장","매우","조금","많이","같이","또한","그리고","그러나","그래서","또한","매우","정말","너무","아주","조금","많이"}
